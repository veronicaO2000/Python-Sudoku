...
def is_valid(puzzle, guess, row, col):
    # figures out whether the guess at the row/col of hte puzle is a valid gues
    # return True if is valid, False other wise
    ...
    # and then the square
    # this is tricky, but we want to get where the 3x3 sqaure starts
